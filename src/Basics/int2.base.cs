...
namespace DCFApixels.DataMath
{
        ...
        IEnumerableVector<int, int2>
    {
        ...
        #region Arithmetic
        [IN(LINE)] public static int2 operator +(int2 a, int2 b) { return new int2(a.x + b.x, a.y + b.y); }
        [IN(LINE)] public static int2 operator +(int2 a, int b) { return new int2(a.x + b, a.y + b); }
        [IN(LINE)] public static int2 operator +(int a, int2 b) { return new int2(a + b.x, a + b.y); }
        ...
        #region Bits
        [IN(LINE)] public static int2 operator ~(int2 a) { return new int2(~a.x, ~a.y); }
        [IN(LINE)] public static int2 operator <<(int2 a, int n) { return new int2(a.x << n, a.y << n); }
        [IN(LINE)] public static int2 operator >>(int2 a, int n) { return new int2(a.x >> n, a.y >> n); }
        ...
        #region Boolean
        [IN(LINE)] public static bool2 operator <(int2 a, int2 b) { return new bool2(a.x < b.x, a.y < b.y); }
        [IN(LINE)] public static bool2 operator <(int2 a, int b) { return new bool2(a.x < b, a.y < b); }
        [IN(LINE)] public static bool2 operator <(int a, int2 b) { return new bool2(a < b.x, a < b.y); }
        ...
        #region Other
        [IN(LINE)] public static int2 operator !(int2 a) { return 1 - a; }
        #endregion
        ...
        public override string ToString() { return $"int2({x}, {y})"; }
        ...
        #region Enumerator
        VectorEnumerator<int, int2> GetEnumerator() { return new VectorEnumerator<int, int2>(this); }
        VectorEnumerator<int, int2> IEnumerableVector<int, int2>.GetEnumerator() { return new VectorEnumerator<int, int2>(this); }
        IEnumerator<int> IEnumerable<int>.GetEnumerator() { return new VectorEnumerator<int, int2>(this); }
        IEnumerator IEnumerable.GetEnumerator() { return new VectorEnumerator<int, int2>(this); }
        #endregion
    }
}