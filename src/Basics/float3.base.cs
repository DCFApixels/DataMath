...
namespace DCFApixels.DataMath
{
        ...
        IEnumerableVector<float, float3>
    {
        ...
        #region Boolean
        [IN(LINE)] public static bool3 operator <(float3 a, float3 b) { return new bool3(a.x < b.x, a.y < b.y, a.z < b.z); }
        [IN(LINE)] public static bool3 operator <(float3 a, float b) { return new bool3(a.x < b, a.y < b, a.z < b); }
