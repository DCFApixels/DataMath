...
namespace DCFApixels.DataMath.TODO
{
    public partial struct float2x2
    {
        ...
        public static implicit operator float2x2(((float, float), (float, float)) v) => new float2x2(v.Item1, v.Item2);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator float2x2(float v) => new float2x2(v);
        //[MethodImpl(MethodImplOptions.AggressiveInlining)]
