...
namespace DCFApixels.DataMath
{
    ...
    //{
    //    #region Abs/Sign
    //    [IN(LINE)] public static T Abs<T>(T a, _4_ _ = default) where T : unmanaged, IVector4Impl<float> { return New<T>(Abs(a.x), Abs(a.y), Abs(a.z), Abs(a.w)); }
    //    [IN(LINE)] public static T Sign<T>(T a, _4_ _ = default) where T : unmanaged, IVector4Impl<float> { return New<T>(Sign(a.x), Sign(a.y), Sign(a.z), Sign(a.w)); }
    //    [IN(LINE)] public static int4 Sign2Int<T>(T a, _4_ _ = default) where T : unmanaged, IVector4Impl<float> { return new int4(Sign2Int(a.x), Sign2Int(a.y), Sign2Int(a.z), Sign2Int(a.w)); }
    //    #endregion
    //
    //    #region Round/Floor/Ceil
    //    [IN(LINE)] public static T Round<T>(T a, _4_ _ = default) where T : unmanaged, IVector4Impl<float> { return New<T>(Round(a.x), Round(a.y), Round(a.z), Round(a.w)); }
    //    [IN(LINE)] public static int4 Round2Int<T>(T a, _4_ _ = default) where T : unmanaged, IVector4Impl<float> { return new int4(Round2Int(a.x), Round2Int(a.y), Round2Int(a.z), Round2Int(a.w)); }
    //    [IN(LINE)] public static T Floor<T>(T a, _4_ _ = default) where T : unmanaged, IVector4Impl<float> { return New<T>(Floor(a.x), Floor(a.y), Floor(a.z), Floor(a.w)); }
    //    [IN(LINE)] public static int4 Floor2Int<T>(T a, _4_ _ = default) where T : unmanaged, IVector4Impl<float> { return new int4(Floor2Int(a.x), Floor2Int(a.y), Floor2Int(a.z), Floor2Int(a.w)); }
    //    [IN(LINE)] public static T Ceil<T>(T a, _4_ _ = default) where T : unmanaged, IVector4Impl<float> { return New<T>(Ceil(a.x), Ceil(a.y), Ceil(a.z), Ceil(a.w)); }
    //    [IN(LINE)] public static int4 Ceil2Int<T>(T a, _4_ _ = default) where T : unmanaged, IVector4Impl<float> { return new int4(Ceil2Int(a.x), Ceil2Int(a.y), Ceil2Int(a.z), Ceil2Int(a.w)); }
    //
    //    [EditorBrowsable(EditorBrowsableState.Never)] [IN(LINE)] public static int4 Round2UInt<T>(T a, _4_ _ = default) where T : unmanaged, IVector4Impl<float> { return new int4(Round2UInt(a.x), Round2UInt(a.y), Round2UInt(a.z), Round2UInt(a.w)); }
    //    [EditorBrowsable(EditorBrowsableState.Never)] [IN(LINE)] public static int4 Floor2UInt<T>(T a, _4_ _ = default) where T : unmanaged, IVector4Impl<float> { return new int4(Floor2UInt(a.x), Floor2UInt(a.y), Floor2UInt(a.z), Floor2UInt(a.w)); }
    //    [EditorBrowsable(EditorBrowsableState.Never)] [IN(LINE)] public static int4 Ceil2UInt<T>(T a, _4_ _ = default) where T : unmanaged, IVector4Impl<float> { return new int4(Ceil2UInt(a.x), Ceil2UInt(a.y), Ceil2UInt(a.z), Ceil2UInt(a.w)); }
    //    #endregion
    //
    //    #region Clamp/Repeat/PingPong
    //    /// <summary> Clamps the value between min and max. </summary>
    //    [IN(LINE)] public static T Clamp<T>(T a, T min, T max, _4_ _ = default) where T : unmanaged, IVector4Impl<float> { return Max(min, Min(max, a)); }
    //    /// <summary> Clamps the value between 0 and 1. </summary>
    //    [IN(LINE)] public static T Clamp01<T>(T a, _4_ _ = default) where T : unmanaged, IVector4Impl<float> { return Clamp(a, New<T>(0f), New<T>(1f)); }
    //    /// <summary> Clamps the value between -1 and 1. </summary>
    //    [IN(LINE)] public static T ClampMirror1<T>(T a, _4_ _ = default) where T : unmanaged, IVector4Impl<float> { return Clamp(a, New<T>(-1f), New<T>(1f)); }
    //
    //    [IN(LINE)] public static T Repeat<T>(T a, T length, _4_ _ = default) where T : unmanaged, IVector4Impl<float> { return Clamp(Sub(a, Mul(Floor(Div(a, length)), length)), New<T>(0f), length); }
    //    [IN(LINE)] public static T Repeat<T>(T a, T min, T max, _4_ _ = default) where T : unmanaged, IVector4Impl<float>  { return Add(Repeat(a, Sub(max, min)), min); }
    //    [IN(LINE)] public static T Repeat01<T>(T a, _4_ _ = default) where T : unmanaged, IVector4Impl<float> { return Repeat(a, New<T>(1f)); }
    //    [IN(LINE)] public static T RepeatMirror1<T>(T a, _4_ _ = default) where T : unmanaged, IVector4Impl<float> { return Repeat(a, New<T>(-1f), New<T>(1f)); }
    //
    //    [IN(LINE)] public static T PingPong<T>(T a, T length, _4_ _ = default) where T : unmanaged, IVector4Impl<float> { return Sub(length, Abs(Repeat(a, Sub(Mul(length, New<T>(2f)), length)))); }
    //    [IN(LINE)] public static T PingPong<T>(T a, T min, T max, _4_ _ = default) where T : unmanaged, IVector4Impl<float> { return Add(PingPong(a, Sub(max, min)), min); }
    //    [IN(LINE)] public static T PingPong01<T>(T a, _4_ _ = default) where T : unmanaged, IVector4Impl<float> { return PingPong(a, New<T>(1f)); }
    //    [IN(LINE)] public static T PingPongMirror1<T>(T a, _4_ _ = default) where T : unmanaged, IVector4Impl<float> { return PingPong(a, New<T>(-1f), New<T>(1f)); }
    //    #endregion
    //
    //    #region SmoothStep
    //    /// <summary> Clamps the value between from and to. </summary>
    //    [IN(LINE)]
    //    public static T SmoothStep<T>(T from, T to, T a, _4_ _ = default) where T : unmanaged, IVector4Impl<float>
    //    {
    //        var t = Clamp01(Div(Sub(a, from), Sub(to, from)));
    //        return Mul(Mul(t, t), Sub(New<T>(3.0f), Mul(New<T>(2.0f), t))); //t * t * (3.0f - (2.0f * t));
    //    }
    //    /// <summary> Clamps the value between 0 and 1. </summary>
    //    [IN(LINE)] public static T SmoothStep01<T>(T a, _4_ _ = default) where T : unmanaged, IVector4Impl<float> { return SmoothStep(a, New<T>(0f), New<T>(1f)); }
    //    /// <summary> Clamps the value between -1 and 1. </summary>
    //    [IN(LINE)] public static T SmoothStepMirror1<T>(T a, _4_ _ = default) where T : unmanaged, IVector4Impl<float> { return SmoothStep(a, New<T>(-1f), New<T>(1f)); }
    //    #endregion
    //
    //    #region All/Any
    //    [IN(LINE)] public static bool All<T>(T a, _4_ _ = default) where T : unmanaged, IVector4Impl<float> { return All(Equals<T>(a, default)); }
    //    [IN(LINE)] public static bool Any<T>(T a, _4_ _ = default) where T : unmanaged, IVector4Impl<float> { return Any(Equals<T>(a, default)); }
    //    #endregion
    //
    //    #region Min/Max/Sum
    //    [IN(LINE)] public static T Max<T>(T a, T b) where T : unmanaged, IVector4Impl<float> { return New<T>(Max(a.x, b.x), Max(a.y, b.y), Max(a.z, b.z), Max(a.w, b.w)); }
    //    [IN(LINE)] public static T AbsMax<T>(T a, T b) where T : unmanaged, IVector4Impl<float> { return New<T>(AbsMax(a.x, b.x), AbsMax(a.y, b.y), AbsMax(a.z, b.z), AbsMax(a.w, b.w)); }
    //    [IN(LINE)] public static T Min<T>(T a, T b) where T : unmanaged, IVector4Impl<float> { return New<T>(Min(a.x, b.x), Min(a.y, b.y), Min(a.z, b.z), Min(a.w, b.w)); }
    //    [IN(LINE)] public static T AbsMin<T>(T a, T b) where T : unmanaged, IVector4Impl<float> { return New<T>(AbsMin(a.x, b.x), AbsMin(a.y, b.y), AbsMin(a.z, b.z), AbsMin(a.w, b.w)); }
    //    [IN(LINE)] public static float CMax<T>(T a) where T : unmanaged, IVector4Impl<float> { return CMax(a.x, a.y, a.z, a.w); }
    //    [IN(LINE)] public static float CAbsMax<T>(T a) where T : unmanaged, IVector4Impl<float> { return CAbsMax(a.x, a.y, a.z, a.w); }
    //    [IN(LINE)] public static float CMin<T>(T a) where T : unmanaged, IVector4Impl<float> { return CMin(a.x, a.y, a.z, a.w); }
    //    [IN(LINE)] public static float CAbsMin<T>(T a) where T : unmanaged, IVector4Impl<float> { return CAbsMin(a.x, a.y, a.z, a.w); }
    //    [IN(LINE)] public static float CSum<T>(T a) where T : unmanaged, IVector4Impl<float> { return (a.x + a.y) + (a.z + a.w); }
    //    #endregion
    //
    //    #region Lerp
    //    [IN(LINE)] public static T Lerp<T>(T start, T end, T t) where T : unmanaged, IVector4Impl<float> { return Add(start, Mul(t, Sub(end, start))); } // start + t * (end - start);
    //    [IN(LINE)] public static T LerpClamp<T>(T start, T end, T t) where T : unmanaged, IVector4Impl<float> { return Lerp(start, end, Clamp01(t)); }
    //    [IN(LINE)] public static T LerpRepeat<T>(T start, T end, T t) where T : unmanaged, IVector4Impl<float> { return Lerp(start, end, Repeat01(t)); }
    //
    //    [IN(LINE)] public static T UnLerp<T>(T start, T end, T a) where T : unmanaged, IVector4Impl<float> { return Div(Sub(a, start), Sub(end, start)); } //(a - start) / (end - start);
    //    [IN(LINE)] public static T UnLerpClamp<T>(T start, T end, T a) where T : unmanaged, IVector4Impl<float> { return Clamp01(UnLerp(start, end, a)); }
    //    [IN(LINE)] public static T UnLerpRepeat<T>(T start, T end, T a) where T : unmanaged, IVector4Impl<float> { return Repeat01(UnLerp(start, end, a)); }
    //
    //
    //    [IN(LINE)]
    //    public static T MoveTowards(T from, T to, float distance)
    //    {
    //        float4 dif = to - from;
    ...
    //    }
    //    [IN(LINE)]
    //    public static float4 MoveTowards(T from, T to, float distance, out float excess)
    //    {
    //        if (distance == 0)
    //        {
    //            excess = 0;
