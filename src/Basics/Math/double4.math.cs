...
namespace DCFApixels.DataMath
{
    ...
    public static partial class DM // double4
    {
        ...
        [IN(LINE)] public static double4 SoftSign(double4 a) { return new double4(SoftSign(a.x), SoftSign(a.y), SoftSign(a.z), SoftSign(a.w)); }
        ...
        [IN(LINE)] public static uint4 Round2UInt(double4 a) { return new uint4(Round2UInt(a.x), Round2UInt(a.y), Round2UInt(a.z), Round2UInt(a.w)); }
        [EditorBrowsable(EditorBrowsableState.Never)]
        [IN(LINE)] public static uint4 Floor2UInt(double4 a) { return new uint4(Floor2UInt(a.x), Floor2UInt(a.y), Floor2UInt(a.z), Floor2UInt(a.w)); }
        [EditorBrowsable(EditorBrowsableState.Never)]
        [IN(LINE)] public static uint4 Ceil2UInt(double4 a) { return new uint4(Ceil2UInt(a.x), Ceil2UInt(a.y), Ceil2UInt(a.z), Ceil2UInt(a.w)); }
        #endregion
        ...
        [IN(LINE)] public static double4 PingPong01(double4 a) { return PingPong(a, 1d); }
        ...
        /// <summary> Clamps the value between 0 and 1. </summary>
        [IN(LINE)] public static double4 SmoothStep01(double4 a) { return SmoothStep(0d, 1d, a); }
        /// <summary> Clamps the value between -1 and 1. </summary>
        [IN(LINE)] public static double4 SmoothStepMirror1(double4 a) { return SmoothStep(-1d, 1d, a); }
        #endregion

        #region All/Any
        [IN(LINE)] public static bool All(double4 a) { return a.x != default && a.y != default && a.z != default && a.w != default; }
        [IN(LINE)] public static bool Any(double4 a) { return a.x != default || a.y != default || a.z != default || a.w != default; }
        #endregion
        ...
        [IN(LINE)]
        public static double4 Slerp(double4 start, double4 end, double t)
        {
            ...
            double4 normStart = start / lengthStart;
            double4 normEnd = end / lengthEnd;
            ...
            double4 direction = normStart * weightStart + normEnd * weightEnd;
            double magnitude = Lerp(lengthStart, lengthEnd, t);

            return direction * magnitude;
        }
        [IN(LINE)] public static double4 SlerpClamp(double4 start, double4 end, double t) { return Slerp(start, end, Clamp01(t)); }
        [IN(LINE)] public static double4 SlerpRepeat(double4 start, double4 end, double t) { return Slerp(start, end, Repeat01(t)); }
        ...
        [IN(LINE)] public static double4 LerpAngleClamp(double4 start, double4 end, double t) { return LerpAngle(start, end, Clamp01(t)); }
        [IN(LINE)] public static double4 LerpAngleRepeat(double4 start, double4 end, double t) { return LerpAngle(start, end, Repeat01(t)); }
        ...
        [IN(LINE)]
        public static double Angle(double4 from, double4 to)
        {
        ...
        [IN(LINE)] public static double4 GammaToLinearSpace(double4 a) { const double Gamma = 2.2d; return Pow(a, Gamma); }
        [IN(LINE)] public static double4 LinearToGammaSpace(double4 a) { const double InverseGamma = 1.0d / 2.2d; return Pow(a, InverseGamma); }
        ...
        #region Pow2
        [IN(LINE)] public static double4 CeilPow2(double4 value) { return new double4(CeilPow2(value.x), CeilPow2(value.y), CeilPow2(value.z), CeilPow2(value.w)); }
        [IN(LINE)] public static double4 FloorPow2(double4 value) { return new double4(FloorPow2(value.x), FloorPow2(value.y), FloorPow2(value.z), FloorPow2(value.w)); }
        [IN(LINE)] public static double4 RoundPow2(double4 value) { return new double4(RoundPow2(value.x), RoundPow2(value.y), RoundPow2(value.z), RoundPow2(value.w)); }
        [IN(LINE)] public static bool4 IsPow2(double4 value) { return new bool4(IsPow2(value.x), IsPow2(value.y), IsPow2(value.z), IsPow2(value.w)); }
        #endregion

        #region Length/Distance/Normalize
        [IN(LINE)] public static double Length(double4 a) { return Sqrt(Dot(a, a)); }
        [IN(LINE)] public static double LengthSq(double4 a) { return Dot(a, a); }
        [IN(LINE)] public static double Distance(double4 a, double4 b) { return Length(b - a); }
        [IN(LINE)] public static double DistanceSq(double4 a, double4 b) { return LengthSq(b - a); }
        ...
        [IN(LINE)] public static bool IsNormalized(double4 a) { return Approximately(CSum(a) - 1d, 0d, DoubleZeroTolerance); }
        #endregion
        ...
        [IN(LINE)] public static double4 Select(double4 falseValue, double4 trueValue, bool4 test) { return new double4(test.x ? trueValue.x : falseValue.x, test.y ? trueValue.y : falseValue.y, test.z ? trueValue.z : falseValue.z, test.w ? trueValue.w : falseValue.w); }
        [IN(LINE)] public static double4 Select(double4 falseValue, double4 trueValue, bool test) { return test ? trueValue : falseValue; }
        [IN(LINE)] public static double4 Step(double4 threshold, double4 a) { return Select(0.0d, 1.0d, a >= threshold); }
        [IN(LINE)] public static int4 Step2Int(double4 threshold, double4 a) { return Select((int4)0, 1, a >= threshold); }
        ...
        [IN(LINE)] public static double4 Sq(double4 a) { return a * a; }
        ...
        [IN(LINE)] public static bool4 Contains(double4 rangePos, double4 rangeSize, double4 pos) { return Contains(rangePos, rangeSize, pos, 1); }
        [IN(LINE)] public static bool4 Contains(double4 rangePos, double4 rangeSize, double4 pos, double4 size) { return (pos >= rangePos) && (pos <= rangeSize + rangePos - size); }
        [IN(LINE)] public static bool4 Overlaps(double4 rangePos, double4 rangeSize, double4 pos) { return Overlaps(rangePos, rangeSize, pos, 1); }
        [IN(LINE)] public static bool4 Overlaps(double4 rangePos, double4 rangeSize, double4 pos, double4 size) { return (pos > rangePos - size) && (pos < rangeSize + rangePos); }
        #endregion
