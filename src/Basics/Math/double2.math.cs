...
namespace DCFApixels.DataMath
{
    ...
    public static partial class DM // double2
    {
        ...
        [IN(LINE)] public static double2 SoftSign(double2 a) { return new double2(SoftSign(a.x), SoftSign(a.y)); }
        ...
        [IN(LINE)] public static double2 PingPong01(double2 a) { return PingPong(a, 1d); }
        ...
        /// <summary> Clamps the value between 0 and 1. </summary>
        [IN(LINE)] public static double2 SmoothStep01(double2 a) { return SmoothStep(0d, 1d, a); }
        /// <summary> Clamps the value between -1 and 1. </summary>
        [IN(LINE)] public static double2 SmoothStepMirror1(double2 a) { return SmoothStep(-1d, 1d, a); }
        #endregion
        ...
        [IN(LINE)]
        public static double2 Slerp(double2 start, double2 end, double t)
        {
            ...
            double2 normStart = start / lengthStart;
            double2 normEnd = end / lengthEnd;
            ...
            double2 direction = normStart * weightStart + normEnd * weightEnd;
            double magnitude = Lerp(lengthStart, lengthEnd, t);

            return direction * magnitude;
        }
        [IN(LINE)] public static double2 SlerpClamp(double2 start, double2 end, double t) { return Slerp(start, end, Clamp01(t)); }
        [IN(LINE)] public static double2 SlerpRepeat(double2 start, double2 end, double t) { return Slerp(start, end, Repeat01(t)); }
        ...
        [IN(LINE)] public static double2 LerpAngleClamp(double2 start, double2 end, double t) { return LerpAngle(start, end, Clamp01(t)); }
        [IN(LINE)] public static double2 LerpAngleRepeat(double2 start, double2 end, double t) { return LerpAngle(start, end, Repeat01(t)); }
        ...
        [IN(LINE)] public static bool2 IsNegative(double2 a) { return new bool2(IsNegative(a.x), IsNegative(a.y)); }
        [IN(LINE)] public static bool2 IsPositive(double2 a) { return new bool2(IsPositive(a.x), IsPositive(a.y)); }
        [IN(LINE)] public static bool2 IsNormalReal(double2 a) { return new bool2(IsNormalReal(a.x), IsNormalReal(a.y)); }
        [IN(LINE)] public static bool2 IsFinite(double2 a) { return new bool2(IsFinite(a.x), IsFinite(a.y)); }
        [IN(LINE)] public static bool2 IsNaN(double2 a) { return new bool2(IsNaN(a.x), IsNaN(a.y)); }
        [IN(LINE)] public static bool2 IsInfinity(double2 a) { return new bool2(IsInfinity(a.x), IsInfinity(a.y)); }
        [IN(LINE)] public static bool2 IsNegativeInfinity(double2 a) { return new bool2(IsNegativeInfinity(a.x), IsNegativeInfinity(a.y)); }
        [IN(LINE)] public static bool2 IsPositiveInfinity(double2 a) { return new bool2(IsPositiveInfinity(a.x), IsPositiveInfinity(a.y)); }
        #endregion

        #region Space Converts
        [IN(LINE)] public static double2 GammaToLinearSpace(double2 a) { const double Gamma = 2.2d; return Pow(a, Gamma); }
        [IN(LINE)] public static double2 LinearToGammaSpace(double2 a) { const double InverseGamma = 1.0d / 2.2d; return Pow(a, InverseGamma); }
        /// <summary> Convert Radians to Degrees. x * 57.296~ </summary>
        [IN(LINE)] public static double2 Degrees(double2 radians) { return radians * Rad2Deg; }
        /// <summary> Convert Degrees to Radians. x * 0.0175~ </summary>
        [IN(LINE)] public static double2 Radians(double2 degrees) { return degrees * Deg2Rad; }
        #endregion
        ...
        #region Pow2
        [IN(LINE)] public static double2 CeilPow2(double2 value) { return new double2(CeilPow2(value.x), CeilPow2(value.y)); }
        [IN(LINE)] public static double2 FloorPow2(double2 value) { return new double2(FloorPow2(value.x), FloorPow2(value.y)); }
        [IN(LINE)] public static double2 RoundPow2(double2 value) { return new double2(RoundPow2(value.x), RoundPow2(value.y)); }
        [IN(LINE)] public static bool2 IsPow2(double2 value) { return new bool2(IsPow2(value.x), IsPow2(value.y)); }
        #endregion

        #region Length/Distance/Normalize
        [IN(LINE)] public static double Length(double2 a) { return Sqrt(Dot(a, a)); }
        [IN(LINE)] public static double LengthSq(double2 a) { return Dot(a, a); }
        [IN(LINE)] public static double Distance(double2 a, double2 b) { return Length(b - a); }
        [IN(LINE)] public static double DistanceSq(double2 a, double2 b) { return LengthSq(b - a); }
        ...
        [IN(LINE)] public static bool IsNormalized(double2 a) { return Approximately(CSum(a) - 1d, 0d, DoubleZeroTolerance); }
        #endregion
        ...
        [IN(LINE)] public static double2 Sq(double2 a) { return a * a; }
        [IN(LINE)] public static double2 Sqrt(double2 a) { return new double2(Sqrt(a.x), Sqrt(a.y)); }
        [IN(LINE)] public static double2 RSqrt(double2 a) { return 1f / Sqrt(a); }
        ...
        [IN(LINE)] public static bool2 Contains(double2 rangePos, double2 rangeSize, double2 pos) { return Contains(rangePos, rangeSize, pos, 1); }
        [IN(LINE)] public static bool2 Contains(double2 rangePos, double2 rangeSize, double2 pos, double2 size) { return (pos >= rangePos) && (pos <= rangeSize + rangePos - size); }
        [IN(LINE)] public static bool2 Overlaps(double2 rangePos, double2 rangeSize, double2 pos) { return Overlaps(rangePos, rangeSize, pos, 1); }
        [IN(LINE)] public static bool2 Overlaps(double2 rangePos, double2 rangeSize, double2 pos, double2 size) { return (pos > rangePos - size) && (pos < rangeSize + rangePos); }
        #endregion
