...
namespace DCFApixels.DataMath
{
    ...
    public static partial class DM // int4
    {
        ...
        //Length - float
        //Distance - float
        [IN(LINE)] public static int LengthSq(int4 a) { return Dot(a, a); }
        [IN(LINE)] public static int4 DistanceSq(int4 a, int4 b) { return Sq(b - a); }
        #endregion

        #region Other
        //Sqrt - float
        [IN(LINE)] public static int Dot(int4 a, int4 b) { return a.x * b.x + a.y * b.y + a.z * b.z + a.w * b.w; }
        [IN(LINE)] public static int4 Sq(int4 a) { return a * a; }
