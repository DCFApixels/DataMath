...
namespace DCFApixels.DataMath
{
    internal static class RandomUtility
    {
        ...
        public const System.Runtime.CompilerServices.MethodImplOptions NOLINE = System.Runtime.CompilerServices.MethodImplOptions.NoInlining;
        ...
        [IN(LINE)]
        public static float Q32ToFloat(uint value) => AsFloat((value >> 9) | 0x3F80_0000) - 1f;
        [IN(LINE)]
        public static double Q64ToDouble(ulong value) => AsDouble((value >> 12) | 0x7FF0_0000_0000_0000) - 1d;


        [IN(LINE)]
        public static uint CompresseU32(uint value, int range) => (uint)((value * (ulong)range) >> 32);
        [IN(LINE)]
        public static int Compresse32(uint value, int range) => (int)((value * (ulong)range) >> 32);
        [IN(LINE)]
        public static uint CompresseU32(uint value, ulong range) => (uint)((value * range) >> 32);
        [IN(LINE)]
        public static int Compresse32(uint value, ulong range) => (int)((value * range) >> 32);
        [IN(LINE)]
        public static uint CompresseU32(uint value, int min, ulong range) => (uint)((value * range) >> 32 + min);
        [IN(LINE)]
        public static int Compresse32(uint value, int min, ulong range) => (int)((value * range) >> 32) + min;
