...
namespace DCFApixels.DataMath
{
    public partial struct uint3
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator uint3(Vector2 a) => new uint3(a.x, a.y, 0f);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator uint3(Vector2Int a) => new uint3(a.x, a.y, 0);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator uint3(Vector3 a) => new uint3(a.x, a.y, a.z);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator uint3(Vector3Int a) => new uint3(a.x, a.y, a.z);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator uint3(Vector4 a) => new uint3(a.x, a.y, a.z);
    }
